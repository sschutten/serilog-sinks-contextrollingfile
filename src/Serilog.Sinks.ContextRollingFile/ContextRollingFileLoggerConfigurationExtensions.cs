...
namespace Serilog
{
    ...
    /// </summary>
    public static class ContextRollingFileLoggerConfigurationExtensions
    {
            ...
            TimeSpan? flushToDiskInterval = null)
        {
            ...
            return ContextRollingFile(sinkConfiguration, formatter, pathFormat, restrictedToMinimumLevel, fileSizeLimitBytes,
